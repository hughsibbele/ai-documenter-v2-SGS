 ...
 * rendering one SystemPromptCard per system prompt) — each editor
 * dispatches via `useAutoSaveDispatch()` and the single pill at the
 * bottom-right reflects whichever save fired most recently.
 */
