    ...
    <div className="mx-auto max-w-2xl space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-stone-600">
          Anyone listed below as <strong>active</strong> can sign into the
          admin console. Email match is case-insensitive against the user&apos;s
          Google email.
        </p>
      </div>
      ...
      <section className="rounded-md border border-stone-200 bg-white">
        <header className="border-b border-stone-100 px-4 py-2 text-[11px] font-semibold uppercase tracking-wide text-stone-500">
      ...
      {revoked.length > 0 && (
        <section className="rounded-md border border-stone-200 bg-stone-50">
          <header className="border-b border-stone-200 px-4 py-2 text-[11px] font-semibold uppercase tracking-wide text-stone-500">
            ...
            {revoked.map((r) => (
              ...
              >
                ...
                <div className="text-[11px]">
                  Granted {formatDate(r.granted_at)} · revoked
                </div>
              </li>
            ))}
          </ul>
